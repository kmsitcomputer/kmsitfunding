...
{
    /**
     * IMP-007 — Program-owned uploaded files, mirroring theme_assets'
     * shape exactly (docs/implementation/IMP-007-campaign-program-fund.md
     * section 8). CASCADE on program_id: an asset has no life independent
     * of its owning Program.
     */
    public function up(): void
    {
        Schema::create('program_media_assets', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('program_media_assets');
    }
};
