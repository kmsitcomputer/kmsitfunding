...
<template>
    <div class="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
        <form class="w-full max-w-sm space-y-4" @submit.prevent="submit">
            <h1 class="text-xl font-semibold text-neutral-800 capitalize">Create a {{ props.actor }} account</h1>
            ...
            <p class="text-sm text-neutral-500">
                This creates only an authenticated identity — no business role or authority is
