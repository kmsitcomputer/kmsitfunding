...
const saveDraft = () => {
    form.patch(`/admin/content/pages/${props.page.ulid}`);
};

const publish = () => {
    publishForm.post(`/admin/content/pages/${props.page.ulid}/publish`);
};

const unpublish = () => {
    unpublishForm.post(`/admin/content/pages/${props.page.ulid}/unpublish`);
};
    ...
    <div class="min-h-screen bg-neutral-50 px-4 py-8">
        <div class="mx-auto max-w-2xl space-y-8">
            <div class="flex items-center justify-between">
                <h1 class="text-xl font-semibold text-neutral-800">{{ props.page.title }}</h1>
                <span class="rounded border px-2 py-1 text-xs text-neutral-600">{{ props.page.status }}</span>
            </div>
            ...
            <section class="space-y-4 rounded border bg-white p-4">
                ...
                <div class="flex flex-wrap items-end gap-2">
                    <div class="flex-1">
                        ...
                        <input v-model="publishForm.path" type="text" class="mt-1 w-full rounded border px-3 py-2" placeholder="/about" />
                    ...
                    <button
                        v-if="props.page.status === 'PUBLISHED'"
                        type="button"
                    ...
                    <button
                        v-if="props.page.status === 'DRAFT' || props.page.status === 'RETIRED'"
                        type="button"
